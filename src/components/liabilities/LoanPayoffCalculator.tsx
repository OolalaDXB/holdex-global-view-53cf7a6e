        ...
        <div className="space-y-6">
          ...
          {selectedLiability && (
            <>
              ...
              {!scenarios && selectedLiability.monthly_payment && selectedLiability.interest_rate && (
                <p className="text-sm text-muted-foreground text-center py-4">
                  Unable to calculate payoff. Check loan details.
                </p>
              )}
            </>
          )}
          ...
          {liabilities.filter(l => l.monthly_payment && l.interest_rate).length === 0 && (
            <p className="text-sm text-muted-foreground text-center py-8">
              No loans with payment schedules available. Add monthly payment and interest rate to your liabilities.
            </p>
          )}
        </div>
      </DialogContent>
