...
interface DemoDebtToIncomeWidgetProps {
  isBlurred?: boolean;
  delay?: number;
}

export function DemoDebtToIncomeWidget({ isBlurred = false, delay = 0 }: DemoDebtToIncomeWidgetProps) {
  const { assets, liabilities, profile } = useDemo();
